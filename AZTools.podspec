#
#  Be sure to run `pod spec lint AZTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "gbammc" => "gbammc@gmail.com" }
  # s.author       = 'gbammc', 'other author'
  ...
  s.source       = { :git => "https://github.com/gbammc/AZTools", :tag => "0.0.1" }
  ...
  s.source_files  = 'UIColor+Helper', 'UIView+Helper'
