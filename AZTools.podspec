Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/gbammc/AZTools.git", :tag => "#{s.version}" }
  s.source_files = 'AZTools.h', 'UIColor+Helper', 'UIView+Helper', 'UIImage+Helper', 'AZNavigationController'
  s.resource     = 'Resource/*'
